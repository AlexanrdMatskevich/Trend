...
Steps:
  ...
  7. element with class 'repo-title' should be like link blue, all star icon should be not solid like now but like bordered, button with class 'BtnGroup' should be allign with class 'today-stars' vertical in the right of element, star in class 'today-stars' should be bordered and not yellow,  button with class 'BtnGroup' should be allign horizontally with name of repository and should have border radius like in https://github.com/trending, button sponsor should have the same border radius like in 'BtnGroup' and align with this button and should have icon like in button sponsor like in https://github.com/trending
